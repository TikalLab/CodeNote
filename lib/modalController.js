...
module.exports = {
  ...
  boardSelected(boardName){
    ...
    request('https://api.trello.com/1/boards/' + selectedBoard.id + '/lists?key=38a81889c8c5c443bf606d7af2db28fd&token=b0215d3c3271ffbafb9aeec69f5245fba803926b3ef49289b0dfff3928713c79',function(error,response,body){
      if(error){
